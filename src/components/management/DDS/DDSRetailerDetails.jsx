      ...
      <div className="bg-gradient-to-t from-green-500 via-green-600 to-teal-600 rounded-t p-3 text-white shadow-md">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 text-center px-2">
            <h1 className="text-sm font-bold">DDS Retailer Details</h1>
            <p className="text-green-100 text-xs hidden sm:block">Filter and export DDS Retailer details</p>
          </div>
...
export default DDSRetailerDetail; 

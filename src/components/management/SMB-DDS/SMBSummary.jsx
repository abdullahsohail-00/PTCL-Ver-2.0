      ...
      <div className="bg-gradient-to-t from-green-500 via-green-600 to-teal-600 rounded-t p-3 text-white shadow-md mx-4 mt-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 text-center px-2">
            <h1 className="text-sm font-bold">SMB Summary</h1>
            <p className="text-green-100 text-xs hidden sm:block">Filter and export SMB summary</p>
          </div>

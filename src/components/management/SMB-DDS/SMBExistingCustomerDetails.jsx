...
const SMBExistingCustomerDetail = () => {
      ...
      <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-t-lg p-3 text-white shadow-lg mx-4 mt-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 text-center px-2">
            <h1 className="text-sm font-bold">SMB Existing Customer Details</h1>
            <p className="text-green-100 text-xs hidden sm:block">Filter and export SMB existing customer details</p>
          </div>
...
export default SMBExistingCustomerDetail; 

...
import { User, MapPin, CreditCard, Settings, Shield, ShoppingCart, CheckCircle, AlertCircle } from 'lucide-react';
...
const NewCustomerOrder = () => {
  ...
  return (
    <div className="w-full">
      {/* Header - Exactly like Vendor Info */}
      <div className="bg-gradient-to-t from-green-500 via-green-600 to-teal-600 rounded-t p-3 text-white shadow-md">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 text-center">
            <h1 className="text-sm font-bold">New Customer Order</h1>
            <p className="text-green-100 text-xs">Create new customer order</p>
          </div>
        ...
        <div className="bg-gray-50 border-x-2 border-b-2 border-gray-200 rounded-b-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="border-r border-gray-200">
              ...
              {/* Order Details */}
              <FormSection title="Order Details" icon={CreditCard}>
                <InputField
                  label="Order For"

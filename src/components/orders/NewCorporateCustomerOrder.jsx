...
const NewCorporateCustomerOrder = () => {
  ...
  return (
    <div className="w-full">
      {/* Header - Same as New Customer Order */}
      ...
      <form onSubmit={handleSubmit}>
        <div className="bg-gray-50 border-x-2 border-b-2 border-gray-200 rounded-b-lg shadow-lg">
          {/* Top Row - NTN, Name, Mobile, Email */}
          <div className="bg-white border-b border-gray-200 p-3">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              <InputField
                label="NTN"
                value={formData.ntn}
                onChange={(value) => handleInputChange('ntn', value)}
            ...
            <div className="border-r border-gray-200">
              ...
              <FormSection title="Personal Information" icon={User}>
                ...
                <InputField
                  ...
                  placeholder="e.g., Office 123, Building 4A"
                />
                <InputField
                  label="Storey/Floor"
                ...
                <InputField
                  ...
                  placeholder="e.g., Sector 15, Gulberg, DHA"
                />
                <InputField
                  label="Zone"
                  value={formData.zone}
            ...
            <div>
              ...
              <FormSection title="Location Details" icon={MapPin}>
                ...
                <InputField
                  ...
                  placeholder="e.g., Near XYZ Tower, Main Boulevard"
                />
                <InputField
                  label="Latitude"
                ...
                <InputField
                  ...
                  options={['Corporate', 'Enterprise', 'SME', 'Government']}
                />
                <InputField
                  label="Select Package"
                  value={formData.selectPackage}
                  onChange={(value) => handleInputChange('selectPackage', value)}
          ...
          {/* Bottom Row - Upload Documents & Comments */}
